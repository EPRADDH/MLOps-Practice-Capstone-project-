...
MLFLOW_TRACKING_URI = "https://dagshub.com/EPRADDH/MLOps-Practice-Capstone-project-.mlflow"
dagshub.init(repo_owner='EPRADDH', repo_name='MLOps-Practice-Capstone-project-', mlflow=True)
